...
export STARTUPWMCLASS=cartridges # For Wayland, this is 'page.kramo.Cartridges', so this needs to be changed in desktop file manually by the user in that case until some potential automatic fix exists for this
...
cp -v /usr/share/gnome-shell/services/search-providers/page.kramo.Cartridges.SearchProvider.ini ./AppDir/share/gnome-shell/services/search-providers/page.kramo.Cartridges.SearchProvider.ini
